...
var guestList = ["Afifa", "Asra", "Mahnoor", "Waniya"];
...
while (guestList.length > 2) {
    ...
    console.log("Sorry ".concat(removedGuests, " I can't you to Dinner!!"));
}
console.log("Invitation to the last 2 Guests");
guestList.forEach(function (lastTwo) { return console.log("Lucily! ".concat(lastTwo, " you are still invited to Dinner")); });
